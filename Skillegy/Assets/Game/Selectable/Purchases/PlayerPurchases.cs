    ...
    private void Start() {
        ...
        purchases = new Dictionary<PurchasesEnum, Purchase>
        {
            ...
            [PurchasesEnum.Gear1] = new LoadingPurchase(
                1, "Gear 1", player.playerControllerId, gear1Image, "Supply barracks with better gear. Increases maximum swordsmanship.",
            ...
            [PurchasesEnum.Gear2] = new LoadingPurchase(
                1, "Gear 2", player.playerControllerId, gear2Image, "Supply barracks with better gear. Increases maximum swordsmanship.",
            ...
            [PurchasesEnum.Gear3] = new LoadingPurchase(
                1, "Gear 3", player.playerControllerId, gear3Image, "Supply barracks with better gear. Increases maximum swordsmanship.",
            ...
            [PurchasesEnum.Gear4] = new LoadingPurchase(
                1, "Gear 4", player.playerControllerId, gear4Image, "Supply barracks with better gear. Increases maximum swordsmanship.",
            ...
            [PurchasesEnum.Gear5] = new LoadingPurchase(
                1, "Gear 5", player.playerControllerId, gear5Image, "Supply barracks with better gear. Increases maximum swordsmanship.",
